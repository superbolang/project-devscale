                ...
                <label className="form-control w-full max-w-xs">
                    ...
                    <select required defaultValue={"Pick one"} name="package" className="select select-bordered">
                        ...
                        {reservationPakages.map(function(pack) {
                            return <option value={pack.name}>{pack.name} | IDR {pack.price} | {pack.includeService.join(", ")}</option>
                        })}
                    </select>
                </label>
                <label className="form-control w-full max-w-xs">
                    ...
                    <Datepicker
                        inputClassName="bg-base-100 input input-bordered w-full max-w-xs"
                        primaryColor={"fuchsia"}  
                        value={valueDatePicker} 
                        onChange={handleValueChangeOnDatePicker} 
                    /> 
                </label>
                <label className="form-control w-full max-w-xs ">
                    <div className="label">
