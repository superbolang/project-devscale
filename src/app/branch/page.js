...
export default function Branch() {
    return(
        <div>
            <div className="hero h-[300px]" style={{backgroundImage: 'url(/banner-branch.jpg)'}}>
                ...
                <div>
                    <div className="flex flex-wrap gap-4 justify-center p-8">
                        <div className="card card-compact w-96 bg-base-100 shadow-xl">
                            <figure><img src="branch.jpg" alt="Shoes" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Branch Name</h2>
                                <p>City</p>
                                <div className="card-actions justify-end">
                                    <a className="btn btn-primary" href="/branch/branch-slug">More</a>
                                </div>
                            </div>
                        </div>
                    </div>
